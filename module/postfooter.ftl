<div class="post_copyright">
    <div class="post_copyright_author">
        ...
        <span class="post_copyright_info"><a href="mailto:undefined" target="_blank">${user.nickname!}</a></span>
    </div>

    <div class="post_copyright_author ellipsis">
        <span class="post_copyright_meta">文章连结:</span>
        <span class="post_copyright_info"><a href="${post.fullPath!}" target="_blank"
                                           title="${post.fullPath!}">${post.fullPath!}</a></span>
    </div>

    <div class="post_copyright_author ellipsis">
        <span class="post_copyright_meta">版权声明:</span>
        <span class="post_copyright_info">本部落格所有文章除特别声明外，均採用 <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/"
...
<#if settings.enable_donate>
    <div class="post_reward center">
        <div class="post_btn">
            <i class="by-font post_icon_qrcode"></i>
            打赏
        </div>
        <div class="post_reward_box animate__animated animate__bounceIn">
